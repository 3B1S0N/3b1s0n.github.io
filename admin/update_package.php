...
$service = get_package_controller($_GET['packageID']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full px-3">
                                            ...
                                            <input class="appearance-none block w-full bg-grey-200 text-grey-darker border border-grey-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-grey"
                                                id="grid-password" type="text" name='name' value="<?php echo $service['package_name']?>">
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full px-3">
                                            ...
                                            <input class="appearance-none block w-full bg-grey-200 text-grey-darker border border-grey-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-grey"
                                                id="grid-password" type="tel" name='price' value="<?php echo $service['package_price']?>">
                                        </div>
                                    </div>
                                    </div>
                                    <input type='hidden' name='packageID' value="<?php echo $service['package_id']?>">
                                    <input type='hidden' name='serviceID' value="<?php echo $service['service_id']?>">
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                            <div class="p-3">
                                                <button class="bg-blue-500 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded-full" name='packageupdate' type="submit">
                                                    Update Package
                                                </button>
                                            </div>
                                    </div>
